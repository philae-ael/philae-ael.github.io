  ...
  if (cookie1 != 34821223 || cookie2 != 2310721022) {
    abort(
      `Stack overflow! Stack cookie has been overwritten at ${ptrToString(
        max
      )}, expected hex dwords 0x89BACDFE and 0x2135467, but received ${ptrToString(cookie2)} ${ptrToString(cookie1)}`
    );
  }
...
var wasmBinaryFile;
wasmBinaryFile = "raylib-game-template.wasm";
...
var writeI53ToI64 = (ptr, num) => {
  ...
  if (deserialized != num)
    warnOnce(
      `writeI53ToI64() out of range: serialized JS Number ${num} to Wasm heap as bytes lo=${ptrToString(HEAPU32[offset])}, hi=${ptrToString(
        HEAPU32[offset + 1]
...
var ___start_em_js = (Module["___start_em_js"] = 293246);
var ___stop_em_js = (Module["___stop_em_js"] = 293319);
